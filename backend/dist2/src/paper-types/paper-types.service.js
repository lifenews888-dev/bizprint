...
exports.PaperTypesService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const paper_type_entity_1 = require("./paper-type.entity");
let PaperTypesService = class PaperTypesService {
    constructor(repo) {
        this.repo = repo;
    }
    findAll() {
...
exports.PaperTypesService = PaperTypesService;
exports.PaperTypesService = PaperTypesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(paper_type_entity_1.PaperType)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], PaperTypesService);
//# sourceMappingURL=paper-types.service.js.map
...
], PrintSizeController.prototype, "findAll", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], PrintSizeController.prototype, "create", null);
exports.PrintSizeController = PrintSizeController = __decorate([
    (0, common_1.Controller)('print-sizes'),
    __param(0, (0, typeorm_1.InjectRepository)(print_size_entity_1.PrintSize)),

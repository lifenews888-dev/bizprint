...
const mergeZoneLayout = (source: LayoutZone[], side: EditorSide, variant: number): LayoutZone[] => {
  ...
  const frontLayouts: Record<string, Partial<LayoutZone>>[] = [
    ...
    {
      logo: { x: 28, y: 32, w: 84, h: 84 },
      company_name: { x: 132, y: 34, w: 248, h: 22, fontSize: 14, align: 'left' },
      company_message: { x: 132, y: 62, w: 236, h: 18, fontSize: 10, align: 'left' },
      full_name: { x: 132, y: 116, w: 286, h: 34, fontSize: 26, fontWeight: 'bold', align: 'left' },
      job_title: { x: 132, y: 154, w: 236, h: 18, fontSize: 11, align: 'left' },
      email: { x: 32, y: 206, w: 126, h: 18, fontSize: 9, align: 'left' },
      phone: { x: 170, y: 206, w: 126, h: 18, fontSize: 9, align: 'left' },
      website: { x: 308, y: 206, w: 110, h: 18, fontSize: 9, align: 'right' },
      address1: { x: 132, y: 232, w: 132, h: 18, fontSize: 8, align: 'left' },
      address2: { x: 276, y: 232, w: 112, h: 18, fontSize: 8, align: 'right' },
      social: { x: 32, y: 138, w: 84, h: 24 },
      qr: { x: 370, y: 34, w: 50, h: 50 },
    },
    {
      logo: { x: 350, y: 34, w: 64, h: 64 },
      company_name: { x: 34, y: 38, w: 254, h: 22, fontSize: 14, align: 'left' },
      company_message: { x: 34, y: 66, w: 230, h: 18, fontSize: 10, align: 'left' },
      full_name: { x: 34, y: 126, w: 370, h: 36, fontSize: 29, fontWeight: 'bold', align: 'left' },
      job_title: { x: 34, y: 166, w: 260, h: 18, fontSize: 11, align: 'left' },
      email: { x: 34, y: 216, w: 140, h: 18, fontSize: 9, align: 'left' },
      phone: { x: 184, y: 216, w: 140, h: 18, fontSize: 9, align: 'left' },
      website: { x: 34, y: 238, w: 148, h: 18, fontSize: 9, align: 'left' },
      address1: { x: 196, y: 238, w: 118, h: 18, fontSize: 8, align: 'left' },
      address2: { x: 316, y: 238, w: 88, h: 18, fontSize: 8, align: 'right' },
      social: { x: 308, y: 104, w: 86, h: 24 },
      qr: { x: 360, y: 164, w: 54, h: 54 },
    },
    {
      logo: { x: 42, y: 108, w: 58, h: 58 },
      company_name: { x: 124, y: 30, w: 276, h: 22, fontSize: 14, align: 'center' },
      company_message: { x: 142, y: 58, w: 240, h: 18, fontSize: 10, align: 'center' },
      full_name: { x: 124, y: 104, w: 276, h: 34, fontSize: 27, fontWeight: 'bold', align: 'center' },
      job_title: { x: 154, y: 144, w: 216, h: 18, fontSize: 11, align: 'center' },
      email: { x: 124, y: 184, w: 130, h: 18, fontSize: 9, align: 'left' },
      phone: { x: 270, y: 184, w: 130, h: 18, fontSize: 9, align: 'right' },
      website: { x: 166, y: 216, w: 190, h: 18, fontSize: 9, align: 'center' },
      address1: { x: 128, y: 238, w: 126, h: 18, fontSize: 8, align: 'left' },
      address2: { x: 268, y: 238, w: 126, h: 18, fontSize: 8, align: 'right' },
      social: { x: 34, y: 184, w: 74, h: 24 },
      qr: { x: 34, y: 38, w: 52, h: 52 },
    },
    {
      logo: { x: 188, y: 164, w: 74, h: 74 },
      company_name: { x: 40, y: 34, w: 370, h: 24, fontSize: 16, align: 'center' },
      company_message: { x: 72, y: 64, w: 306, h: 18, fontSize: 10, align: 'center' },
      full_name: { x: 50, y: 100, w: 350, h: 34, fontSize: 26, fontWeight: 'bold', align: 'center' },
      job_title: { x: 98, y: 136, w: 254, h: 18, fontSize: 11, align: 'center' },
      email: { x: 34, y: 202, w: 122, h: 18, fontSize: 9, align: 'left' },
      phone: { x: 294, y: 202, w: 122, h: 18, fontSize: 9, align: 'right' },
      website: { x: 34, y: 228, w: 122, h: 18, fontSize: 9, align: 'left' },
      address1: { x: 294, y: 228, w: 122, h: 18, fontSize: 8, align: 'right' },
      address2: { x: 166, y: 242, w: 118, h: 18, fontSize: 8, align: 'center' },
      social: { x: 180, y: 34, w: 90, h: 24 },
      qr: { x: 34, y: 112, w: 52, h: 52 },
    },
    {
      logo: { x: 36, y: 196, w: 50, h: 50 },
      company_name: { x: 34, y: 34, w: 178, h: 22, fontSize: 14, align: 'left' },
      company_message: { x: 34, y: 62, w: 178, h: 18, fontSize: 10, align: 'left' },
      full_name: { x: 226, y: 42, w: 190, h: 56, fontSize: 30, fontWeight: 'bold', align: 'right' },
      job_title: { x: 226, y: 108, w: 190, h: 18, fontSize: 11, align: 'right' },
      email: { x: 226, y: 158, w: 150, h: 18, fontSize: 9, align: 'right' },
      phone: { x: 226, y: 180, w: 150, h: 18, fontSize: 9, align: 'right' },
      website: { x: 226, y: 202, w: 150, h: 18, fontSize: 9, align: 'right' },
      address1: { x: 92, y: 198, w: 114, h: 18, fontSize: 8, align: 'left' },
      address2: { x: 92, y: 220, w: 114, h: 18, fontSize: 8, align: 'left' },
      social: { x: 34, y: 106, w: 88, h: 24 },
      qr: { x: 378, y: 166, w: 46, h: 46 },
    },
    {
      logo: { x: 188, y: 36, w: 74, h: 74 },
      company_name: { x: 34, y: 128, w: 382, h: 22, fontSize: 14, align: 'center' },
      company_message: { x: 78, y: 154, w: 294, h: 18, fontSize: 10, align: 'center' },
      full_name: { x: 44, y: 190, w: 362, h: 34, fontSize: 26, fontWeight: 'bold', align: 'center' },
      job_title: { x: 98, y: 226, w: 254, h: 18, fontSize: 11, align: 'center' },
      email: { x: 30, y: 36, w: 120, h: 18, fontSize: 9, align: 'left' },
      phone: { x: 300, y: 36, w: 120, h: 18, fontSize: 9, align: 'right' },
      website: { x: 30, y: 62, w: 120, h: 18, fontSize: 9, align: 'left' },
      address1: { x: 300, y: 62, w: 120, h: 18, fontSize: 8, align: 'right' },
      address2: { x: 300, y: 88, w: 120, h: 18, fontSize: 8, align: 'right' },
      social: { x: 30, y: 88, w: 78, h: 24 },
      qr: { x: 368, y: 132, w: 50, h: 50 },
    },
    {
      logo: { x: 358, y: 202, w: 54, h: 54 },
      company_name: { x: 36, y: 34, w: 320, h: 22, fontSize: 14, align: 'left' },
      company_message: { x: 36, y: 62, w: 280, h: 18, fontSize: 10, align: 'left' },
      full_name: { x: 36, y: 104, w: 222, h: 64, fontSize: 32, fontWeight: 'bold', align: 'left' },
      job_title: { x: 36, y: 176, w: 220, h: 18, fontSize: 11, align: 'left' },
      email: { x: 282, y: 104, w: 128, h: 18, fontSize: 9, align: 'right' },
      phone: { x: 282, y: 126, w: 128, h: 18, fontSize: 9, align: 'right' },
      website: { x: 282, y: 148, w: 128, h: 18, fontSize: 9, align: 'right' },
      address1: { x: 282, y: 170, w: 128, h: 18, fontSize: 8, align: 'right' },
      address2: { x: 282, y: 192, w: 128, h: 18, fontSize: 8, align: 'right' },
      social: { x: 36, y: 224, w: 90, h: 24 },
      qr: { x: 356, y: 34, w: 54, h: 54 },
    },
  ]

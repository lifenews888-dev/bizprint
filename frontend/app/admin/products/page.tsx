...
// Order matters: more specific keywords first (e.g. "нэрийн хуудас" before "хуудас")
const EMOJI_RULES: Array<[string, string]> = [
  // Mongolian — specific first
  ['нэрийн хуудас', '💳'], ['бизнес карт', '💳'],
  ['товгор үсэг', '🔤'], ['нерж', '✨'], ['3d үсэг', '🎯'], ['pvc үсэг', '🏷️'],
  ['ундааны сав', '🥤'], ['усны сав', '💧'], ['drinkware', '🥤'],
  ['хавсралт', '📎'], ['хавсрал', '📎'],
  ['хувцасны нэмэлт', '🧣'], ['нэмэлт хэрэгсэл', '🧰'],
  ['хувцас', '👕'], ['майк', '👕'], ['хормогч', '🧺'], ['сорочка', '👔'],
  ['футболк', '👕'], ['цамц', '👔'], ['гадуур хувцас', '🧥'],
  ['малгай', '🧢'], ['бэйсбол малгай', '🧢'], ['тракер малгай', '🧢'],
  ['цүнх', '👜'], ['мессенжер', '💼'], ['үүргэвч', '🎒'], ['портфель', '💼'],
  ['хормогч', '🧺'], ['багц', '👝'],
  ['гэр ахуй', '🏠'], ['гэр', '🏠'],
  ['зууш', '🍬'], ['чихэр', '🍭'], ['амттан', '🍪'],
  ['нарны соя', '🕶️'], ['нарны шил', '🕶️'],
  ['бэйсбол', '⚾'], ['спорт', '⚽'], ['гольф', '⛳'], ['аялал', '🧳'],
  ['бэлэг', '🎁'], ['фото бэлэг', '📸'], ['подарок', '🎁'],
  ['технологи', '💻'], ['usb', '🔌'], ['цэнэглэгч', '🔋'], ['чихэвч', '🎧'],
  ['стикер', '🏷️'], ['наалт', '🏷️'],
  ['туг', '🚩'], ['далбаа', '🚩'], ['дарцаг', '🚩'],
  ['баннер', '🪧'], ['роллап', '🪧'], ['самбар', '🪧'],
  ['ширээ', '🗄️'],
  ['ном', '📚'], ['сэтгүүл', '📰'], ['каталог', '📖'], ['брошур', '📘'],
  ['урилга', '💌'], ['хурим', '💒'], ['баяр', '🎉'],
  ['флаер', '📃'], ['хуудас', '📄'], ['постер', '🖼️'],
  ['дизайн', '🎨'], ['загвар', '🎨'],
  ['офсет', '🖨️'], ['хэвлэл', '🖨️'], ['хэвлэмэл', '🖨️'],
  ['дугуй захтай', '👔'], ['нимгэн', '👕'], ['өмд', '👖'], ['шорт', '🩳'],
  ['хайрцаг', '📦'], ['сав баглаа', '📦'], ['packaging', '📦'], ['коробка', '📦'],
  ['шошго', '🏷️'], ['label', '🏷️'],
  ['хүрэм', '🧥'], ['цув', '🧥'],
  ['офис', '🖊️'], ['бичиг хэрэгсэл', '✏️'], ['pen', '🖊️'], ['бал', '🖊️'],
  ['promotional', '🎁'], ['сурталчилгаа', '📢'],
  // English fallbacks
  ['book', '📚'], ['sticker', '🏷️'], ['banner', '🪧'], ['poster', '🖼️'],
  ['card', '💳'], ['flyer', '📃'], ['brochure', '📖'],
  ['bag', '👜'], ['backpack', '🎒'], ['briefcase', '💼'],
  ['mug', '☕'], ['bottle', '🍶'], ['tumbler', '🥤'],
  ['shirt', '👕'], ['tshirt', '👕'], ['tank top', '🎽'], ['apron', '🧺'],
  ['clothing', '👕'], ['hat', '🧢'], ['cap', '🧢'], ['visor', '🧢'],
  ['photo', '📷'], ['tech', '💻'], ['technology', '💻'],
  ['snacks', '🍬'], ['candies', '🍭'], ['writing', '✏️'],
  ['travel', '🧳'], ['award', '🏆'], ['signage', '🪧'], ['flag', '🚩'],
  ['invitation', '💌'], ['stationery', '✏️'], ['gift', '🎁'],
  // Admin category codes (legacy)
  ['hadag_reklam', '🪧'], ['khevlel', '🖨️'], ['extra', '✨'],
]

...
const PAPERS = [
  ...
  'Kraft цаас', 'Vinyl (наалт)', 'Синтетик (усанд тэсвэртэй)', 'Canvas',
...
const CONTACTS = [
  { v: 'chat',  l: 'Дотоод чат',  i: '💬', d: 'Шууд энэ сайтаар' },
  { v: 'viber', l: 'Viber',        i: '📱', d: 'Viber дугаараар' },
  { v: 'email', l: 'И-мэйл',      i: '📧', d: 'Имэйлээр' },
  { v: 'phone', l: 'Утас',         i: '📞', d: 'Утасаар залгана' },
];
...
export default function NewOrderPage() {
  ...
  return (
    <div className="max-w-xl mx-auto py-8 px-4">
      ...
      <p className="text-sm text-gray-500 mb-6">Мэдээллийг бөглөж илгээнэ үү</p>
      ...
      {step === 3 && (
        <div className="space-y-5">
          <div>
            <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Хариу хэрхэн авах вэ?</p>
        ...
        <div className="space-y-4">
          <div className="border border-gray-200 dark:border-gray-700 rounded-2xl divide-y divide-gray-100 dark:divide-gray-800">
            {[
              ...
              ['Эх бэлтгэл', spec.hasDesign ? 'Бэлэн байна' : spec.needsDesign ? 'Дизайн хийлгэх' : '—'],
